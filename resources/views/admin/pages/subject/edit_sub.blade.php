    ...
    <div class="container">
        ...
        <form action="{{ route('subject.update', $subject->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input value="{{ $subject->name }}" required type="text" class="form-control" id=""
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" placeholder="Enter Subject description" name="description" id="" cols="30"
